...
@section('content')
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="bg-white">
                <div x-data="{ filter: false }" x-init="filter = false">
                        ...
                        <div class="fixed inset-0 z-40 flex">
                            <div class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                ...
                                <form id="product-filter" class="mt-4 border-t border-gray-200" >
                                    ...
                                    <div x-data="{ rating: true }" x-init="rating = true" class="border-t border-gray-200 px-4 py-6">
                    ...
                    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="flex items-baseline justify-between border-b border-gray-200 pt-12 pb-6">
                            ...
                            <div x-data="{ open: false }" x-init="open = false" class="flex items-center">
                        ...
                        <section aria-labelledby="products-heading" class="pb-12 pt-6">
                            ...
                            <!-- Filters -->
                                <form class="hidden lg:block">
                                    ...
                                    <div x-data="{ color: true }" x-init="color = true" class="border-b border-gray-200 py-6">
                                    ...
                                    <div x-data="{ rating: true }" x-init="rating = true" class="border-b border-gray-200 py-6">
                                        <h3 class="-my-3 flow-root">
                                            <!-- Expand/collapse section button -->
